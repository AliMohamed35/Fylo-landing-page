function Access (){
    ...
    <section className="flex items-center justify-center pt-10 md:pt-30 pb-16 md:pb-5 px-7 relative z-10" style={{background: "linear-gradient(to bottom, #181e2a 50%, #0b1524 50%)"}}>
        <div className="text-white bg-[#1c2230] md:max-w-250 p-5 md:p-20 text-center rounded-2xl shadow-2xl">
            ...
            <div className="mt-15 flex flex-col gap-5 md:flex-row  justify-center w-full">
                <input type="text" placeholder="email@example.com" className="bg-white md:w-[70%] px-5 py-3 text-black rounded-full" />
                <button className="bg-[#47bdd1] p-5 rounded-full">Get Started From Free</button>
            </div>
        </div>
    </section>
    </>
